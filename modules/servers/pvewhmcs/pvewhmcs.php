...
function pvewhmcs_CreateAccount($params)
{
    ...
    if (!empty($params['customfields']['KVMTemplate'])) {
        ...
        if ($plan->vmtype == 'lxc') {
            ...
            ///////////////////////////
            $vm_settings['ostemplate'] = $plan->os_storage.':vztmpl/'.$params['customfields']['Template'];
        ...
        if ($vm_status !== null) {
            ...
            if ($guest->vtype == 'lxc') {
                ...
                if ($ct_specific['maxswap'] > 0) {
                    ...
                    $vm_status['swapusepercent'] = 0; // Or some other fallback value
                }
            }
        } else {
...
function pvewhmcs_vmReboot($params)
{
    ...
    if ($proxmox->login()) {
        ...
        try {
            ...
            return "- VM is stopped, you ca not run this action";
        }
